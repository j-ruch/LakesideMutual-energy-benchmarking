...
change_spring_boot_version() {
  ...
  echo "+================================+"
  change_spring_boot_version_command_customer_core="$CUSTOMER_CORE_HOME/mvnw -f $CUSTOMER_CORE_HOME/pom.xml versions:update-parent -DparentVersion=[$spring_boot_version] -DgenerateBackupPoms=false"
  change_spring_boot_version_command_customer_management="$CUSTOMER_MANAGEMENT_HOME/mvnw -f $CUSTOMER_MANAGEMENT_HOME/pom.xml versions:update-parent -DparentVersion=[$spring_boot_version] -DgenerateBackupPoms=false"
  change_spring_boot_version_command_customer_self_service="$CUSTOMER_SELF_SERVICE_HOME/mvnw -f $CUSTOMER_SELF_SERVICE_HOME/pom.xml versions:update-parent -DparentVersion=[$spring_boot_version] -DgenerateBackupPoms=false"
  change_spring_boot_version_command_policy_management="$POLICY_MANAGEMENT_HOME/mvnw -f $POLICY_MANAGEMENT_HOME/pom.xml versions:update-parent -DparentVersion=[$spring_boot_version] -DgenerateBackupPoms=false"
